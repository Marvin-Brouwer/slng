...
describe("ResponsePanel", () => {
  ...
  it("creates a webview panel with the export name in the title", () => {
    ResponsePanel.show(ctx as never, createResult() as never, true);
  ...
  it("applies success styling for 2xx status codes", () => {
    ResponsePanel.show(ctx as never, createResult({ status: 201 }) as never, true);
  ...
  it("applies error styling for 4xx/5xx status codes", () => {
    ResponsePanel.show(ctx as never, createResult({ status: 500 }) as never, true);
